...
<header class="swiper featured-posts-slider h-[75vh]  sm:h-[55vh]  rounded-xl group">
    <div class="swiper-wrapper">
        ...
        <article wire:key="featured-post-{{$post->id}}"
            class="swiper-slide  p-12 bg-center bg-no-repeat bg-cover bg-blend-multiply bg-gray-500  "
            ...
            <div class="w-5/5 md:w-4/5 2xl:w-3/5 h-full flex flex-col justify-end items-start gap-6">
                ...
                <x-base.link-btn notNavigated={{false}} class="self-start mt-4 z-30"
                    href="{{route('blog.show', $post->slug)}}">Zobacz
                </x-base.link-btn>
