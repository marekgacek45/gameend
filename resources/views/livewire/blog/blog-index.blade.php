<div class="flex py-8 px-2 md:px-8  gap-8">
    ...
    <div class="hidden xl:block w-3/12 space-y-6">
        ...
        <x-filter-box title="Kategorie">
            ...
            @if (($index + 1) % 5 == 0)
            <li class="w-full flex justify-center"><a href="#"
        ...
        <x-filter-box title="Tagi">
            ...
            <x-filter-item postCount filter="tag" :item="$tag" href="{{ route('home', ['tag' => $tag->slug]) }}" />
        ...
        <x-filter-box title="Ukończone gry">
            ...
            <x-filter-item filter="completedGame" :item="$game" href="#" />
        ...
        <x-filter-box title="Top of the Top">
            ...
            <x-filter-item filter="topGame" :item="$game" href="#" />
