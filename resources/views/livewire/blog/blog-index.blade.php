<div class="flex py-8 px-2 md:px-8  gap-8">
    ...
    <div class="hidden xl:block w-3/12 space-y-6">
        ...
        <x-filter-box title="Kategorie">
            ...
            <x-filter-item postCount :key="'category-' . $category->id" :item="$category" href="#" />

            @if (($index + 1) % 5 == 0)
            <li class="w-full flex justify-center"><a href="#" class="bg-secondary-400 hover:bg-primary-200 duration-500 rounded-full px-6 py-1 mt-3">Zobacz wszystkie</a></li>
            @endif
            @endforeach
        ...
        <x-filter-box title="Tagi">
            ...
            <x-filter-item postCount :key="'tag-' . $tag->id" :item="$tag" href="#" />
    ...
    <div class="w-full xl:w-9/12 space-y-12 ">
        ...
        <header class="swiper featured-posts-slider h-[80vh]  sm:h-[55vh]  rounded-xl">
            <div class="swiper-wrapper">
                ...
                <div class="  swiper-slide bg-center bg-no-repeat bg-cover bg-blend-multiply bg-gray-500  p-12"
                    ...
                    <div class="w-4/5 2xl:w-3/5 h-full flex flex-col justify-end items-start gap-6">
                        <h1 class="text-4xl 2xl:text-5xl font-semibold">
